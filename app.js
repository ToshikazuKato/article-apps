...
io.on('connection',function(socket){
	if(socket.request.session.user){
		...
		socket.on('chatMessageFromBrowser', function (data) {
			// send message to everyone in the browser -> io
			// send message to only client that has requested -> socket
			// send message to everyone connected except client that has requested -> socket.broadcast
